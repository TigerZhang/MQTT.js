 ...
 * @param <Buffer> buffer - destination
 * @param <Number> pos - offset
 * @param <String> len - length to write
 * @return <Number> number of bytes written
 */
function write_message_id_len64(buffer, pos, len) {
    bops.writeUInt32BE(buffer, len >> 32, pos);
    bops.writeUInt32BE(buffer, len & 0xFFFFFFFF, pos + 4);
