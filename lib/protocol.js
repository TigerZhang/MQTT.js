...
module.exports.VERSION13 = 0x13;

module.exports.extend_types = {
    0: "topics",
    1: "payload",
    2: "platform",
    3: "time_to_live",
...
module.exports.extend_codes = {}
for(var k in module.exports.extend_types){
    var v = module.exports.extend_types[k];
    module.exports.extend_codes[v] = k;
}