...
/**
 * get_state2 - expand command: get
 *
 * @param {String} alias - alias name
 * @param {Function} [callback] - function(err, payload){}
 *    called when get_state2 succeeds or fails
 * @returns {MqttClient} this - for chaining
 * @api get_state2
 *
 * @example client.get_state2("alias", function(err, payload){console.log(payload)});
 */
MqttClient.prototype.get_state2 =
    function(alias, callback) {
        if("string" === typeof alias){
            var opts = {
                command: 19,
...
/**
 * get_topic_list2 - expand command: get
 *
 * @param {String} alias - alias name
 * @param {Function} [callback] - function(err, payload){}
 *    called when get_topic_list2 succeeds or fails
 * @returns {MqttClient} this - for chaining
 * @api where_now
 *
 * @example client.get_topic_list2("alias", function(err, payload){console.log(payload)});
 */
MqttClient.prototype.get_topic_list2 =
    function(alias, callback) {
        if("string" === typeof alias){
            var opts = {
                command: 13,
...
/**
 * get_alias_list2 - expand command: get
 *
 * @param {String} topic - topic name
 * @param {Function} [callback] - function(err, payload){}
 *    called when get_alias_list2 succeeds or fails
 * @returns {MqttClient} this - for chaining
 * @api here_now
 *
 * @example client.get_alias_list2("alias", function(err, payload){console.log(payload)});
 */
MqttClient.prototype.get_alias_list2 =
    function(topic, callback) {
        if("string" === typeof topic){
            var opts = {
                command: 15,
