...
parser.pubrel =
parser.pubcomp =
parser.unsuback = function (buf, packet, opts) {
  parser._len = buf.length;
  parser._pos = 0;
    var opts = opts || {};
...
parser.subscribe = function(buf, packet, opts) {
  parser._len = buf.length;
  parser._pos = 0;
    var opts = opts || {};
...
parser.suback = function(buf, packet, opts) {
  parser._len = buf.length;
  parser._pos = 0;
    var opts = opts || {};
...
parser.unsubscribe = function(buf, packet, opts) {
  parser._len = buf.length;
  parser._pos = 0;
    var opts = opts || {};
